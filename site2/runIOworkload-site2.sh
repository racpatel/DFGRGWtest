...
#site1ObjCountStart=`ssh f18-h05-000-r640 "ceph df|grep site1.rgw.buckets.data" |awk '{print$6}'`
...
#    Utils/postpoll.sh_datalog ${pollinterval} ${LOGFILE} ${DATALOG} 
    Utils/postpoll.sh ${pollinterval} ${LOGFILE}
#    PIDpostpoll=$!
