...
testname=bb-hybrid48hr-site1-$comment
...
echo `date +%y/%m/%d" "%H:%M` " bb-hybrid-48hr ..."
./runIOworkload-site1.sh bb-hybridSS-48hr.xml
...
#if [[ $cephadmshell != "true" ]]; then
#    echo " " | mail -s "RGWtest site1 bb-hybrid-48hr (${jobId}) complete" <email.address>
#fi
