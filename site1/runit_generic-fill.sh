...
# Variables
source "./RGWtest/vars.shinc"

# Functions
source "./RGWtest/Utils/functions.shinc"
...
./runIOworkload-site1.sh fillWorkload-prep.xml
...
#if [[ $cephadmshell != "true" ]]; then
#    echo " " | mail -s "RGWtest site1 fill (${jobId}) complete" <email.address>
#fi
